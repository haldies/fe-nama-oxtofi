...
import SeacrhPage from './components/searh';
import IconNotif from './components/icons/notifikasi';
import IconPesan from './components/icons/pesan';
...
const App: React.FC<AppProps> = () => {
  ...
  return (
    <main   >
      ...
      <nav onMouseLeave={handleMouseLeave} className={styles.categoriesMenuPackage}>
              ...
              <div key={subcategory.title} >
                ...
                <ul>
                  {subcategory.list.map((item) => (
                    <li className={styles.listItem} key={item}><a href="">{item}</a></li>
                  ))}
                </ul>
              </div>
            ))}
